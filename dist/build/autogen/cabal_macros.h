...
/* package mario-0.1.0.0 */
#define VERSION_mario "0.1.0.0"
#define MIN_VERSION_mario(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "mario-0.1.0.0"

#define CURRENT_PACKAGE_KEY "mario-0.1.0.0"
